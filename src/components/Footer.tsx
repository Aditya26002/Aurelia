...
const Footer = () => {
  return (
    <div className="py-24 px-4 md:px-7 lg:px-14 xl:px-28 2xl:px-60 bg-gray-100 text-sm mt-24">
      {/* TOP */}
      <div className="flex flex-col md:flex-row justify-between gap-24">
        {/* LEFT */}
        <div className="w-full items-center lg:w-1/4 md:w-1/2 flex flex-col gap-8">
          <Link href="/">
            <div className="text-2xl tracking-wider">AURELIA</div>
          </Link>
          <span className="font-semibold">hello@aurelia.dev</span>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between gap-8 mt-16">
        <div className="">© 2024 Aurelia</div>
